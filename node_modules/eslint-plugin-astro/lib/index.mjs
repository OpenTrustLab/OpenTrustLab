...
// src/plugin-without-config.ts
var plugin_without_config_exports = {};
__export(plugin_without_config_exports, {
  environments: () => environments,
  meta: () => meta_exports,
  processors: () => processors,
  rules: () => rules2
});
var rules2, processors;
var init_plugin_without_config = __esm({
  "src/plugin-without-config.ts"() {
    init_rules2();
    init_processor();
    init_meta();
...
var plugin2, _a, _b, base_default;
var init_base = __esm({
    ...
    base_default = [
      {
        plugins: {
          get astro() {
            return plugin2 != null ? plugin2 : plugin2 = (init_plugin_without_config(), __toCommonJS(plugin_without_config_exports));
          }
        }
      },
      {
...
var baseExtend = "plugin:astro/base";
...
// src/index.mts
init_plugin_without_config();
var configs = buildEsmConfigs();
var src_default = { meta: meta_exports, configs, rules: rules2, processors, environments };

export { configs, src_default as default, environments, meta_exports as meta, processors, rules2 as rules };
